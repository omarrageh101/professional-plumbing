        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-xl text-muted-foreground mb-6">
              Die Firma wurde 1999 von Claus Oerlicke, Sanitärinstallateur- und Heizungsbaumeister gegründet. 
            ...
            <div className="absolute bottom-6 left-6 right-6 glassmorphism rounded-xl p-6 text-white">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <div className="text-sm opacity-90">0661 942 7416</div>
                </div>
              </div>
            </div>
          </div>
